...
# Enter yoiur first name and last name in first_name and last_name variables. If the length of your first name is under
...
result_4 = None
number_2 = int(input("Enter a number between10 and 20 (inclusive) ") )
