...
def test_fahrenheit():
    # Write your first program. Input the temperature right now in Fahrenheit and convert it to Celsius.
    ...
    assert (temperature_fahrenheit - 32) * 5 / 9 == result_temperature
